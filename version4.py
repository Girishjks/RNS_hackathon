...
# self.root is the main Tkinter window.
# self.style configures the styles for buttons and labels using ttk.Style.
# self.label displays the title "Virus Scanner".
# self.text_area is a text widget where scan results are shown.
# self.scan_button is a button that triggers the directory scan
    ...
    def scan_file(self, file_path):
        with open(file_path, "rb") as f:
            ...
            if virus_signature in file_content:
                return f"Virus found in file virus type EICAR Test File-This is a harmless file that antivirus and malware scanners recognize as a threat. It's often used for testing purposes: {file_path}\n"
            else:
